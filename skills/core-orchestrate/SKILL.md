---
name: orchestrate
description: Decompose work into sub-agent tasks, dispatch by role, and aggregate results
argument-hint: <work-description> | status | decompose <sprint-item> | dispatch <role> <task>
---
