---
name: dispatch
description: Tier-aware workflow execution engine — reads workflow JSON, evaluates tier gates, dispatches sub-agents, and tracks completion
argument-hint: <workflow-name> [--stage <name>] [--dry-run]
---
