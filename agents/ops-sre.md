...
2. Evaluate: pipeline efficiency, deployment safety (rollback, canary, health checks), observability gaps
3. Identify single points of failure and reliability risks
4. Propose operational improvements with concrete rationale
5. For incidents: triage severity, suggest containment, propose root cause analysis steps
