...
2. Evaluate the problem: what are the constraints, scale requirements, and cross-cutting concerns
3. Propose design options with explicit trade-offs (pros/cons for each)
4. Recommend the simplest design that meets the requirements
5. Document the decision with rationale in an Architecture Decision Record format
6. Identify risks: coupling, scalability bottlenecks, security implications, maintenance burden
