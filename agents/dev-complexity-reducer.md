...
## model: sonnet name: complexity-reducer description: Flag high-cyclomatic-complexity functions and suggest simplifications tools: Glob, Grep, Read
...
Scan the project's Python source for these complexity issues:
