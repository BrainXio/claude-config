...
1. Design test cases: happy path, edge cases, error states, boundary conditions
1. Identify what the automated tests cover vs what needs manual verification
1. Create a test plan with priority levels (P0: must-pass, P1: should-pass, P2: nice-to-have)
1. Flag missing acceptance criteria or untestable requirements
