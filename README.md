...
| Category     | Contents                                                                                                              |
| ------------ | --------------------------------------------------------------------------------------------------------------------- |
| **Settings** | `settings/*.json` files compose into `settings.json` (core, env, hooks, permissions, sandbox, model, env-ollama-*, mcp-*) |
...
| `settings/mcp-brainxio-claude-hiring.json`    | brainxio-claude-hiring MCP server tool permissions             |
| `settings/mcp-brainxio-claude-meetings.json`  | brainxio-claude-meetings MCP server tool permissions           |
| `settings/mcp-filesystem.json`                | filesystem MCP server tool permissions                         |
| `settings/mcp-sequential-thinking.json`       | sequential-thinking MCP server tool permissions                |
| `settings/mcp-time.json`                      | time MCP server tool permissions                               |
| `settings/mcp-fetch.json`                     | fetch MCP server tool permissions                              |
...
- Settings files compose via deep merge: `cat settings/*.json | jq -s 'reduce .[] as $item ({}; . * $item)'`
